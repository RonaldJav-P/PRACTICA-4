    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Producto__3214EC07680432F8", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Usuarios__3214EC07D21C930B", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "UQ__Producto__A25C5AA78989B5DE",
                table: "Productos",
                column: "Code",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "UQ__Usuarios__A9D1053426E3BDE4",
                table: "Usuarios",
                column: "Email",
                unique: true);
        }
